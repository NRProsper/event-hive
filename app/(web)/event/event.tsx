    ...
    return (
        event && (
            <div className="my-8">
                <Container>
                    <div
                        className="relative h-auto lg:h-[595px] rounded-md overflow-hidden flex flex-col gap-10 lg:flex-row items-start lg:items-center justify-between py-10 px-10 xl:px-20"
                        style={{
                    ...
                    >
                        ...
                        <div
                            className="relative w-full md:w-auto mt-20 lg:mt-0 p-6 bg-white rounded-[10px] md:min-w-[385px]">
                            ...
                            <BookingDialog refetch={refetch} event={event}/>
                        </div>
                    </div>
                    <div className="mt-10 px-10 xl:px-20 flex flex-col lg:flex-row items-start gap-20">
                        <div className="flex-1 flex flex-col gap-5">
                            ...
                            <div className="">
                                ...
                                <p className="mt-2 text-grey">Please go to {event.organizerUrl} and refer the FAQ
                                    section
                                    for
                                    more detail</p>
                            </div>
